                                    ...
                                    <Row>
                                        <Col xs={12}>
                                            ...
                                            <p className="cooperation-description-paragraph-lead">
                                                Компания DECKLINE GROUP - один из быстро растущих лидеров на рынке
                                                террасной
                                            ...
                                            <p>
                                                Чтобы стать дилером компании DECKLINE GROUP и приобретать наши товары на
                                            ...
                                            <h3>
                                                Дилерство в компании DECKLINE GROUP - это выгодно!
                                            </h3>
                                            <hr/>
                                        </Col>
                                    </Row>
