                                ...
                                <Row>
                                    <Col xs={12}>
                                        ...
                                        <p className="cooperation-description-paragraph-lead">
                                            Компания POLIVAN GROUP - один из быстро растущих лидеров на рынке террасной
                                        ...
                                        <p>
                                            Важным направлением развития для нашей компании стало установление надежных
                                            ...
                                            предоставить наиболее выгодные условия поставок, оптовые цены и всестороннюю
                                            рекламно-информационную поддержку.
                                        </p>
                                        <p>
                                            Продукция поставляется дилерам в широком ассортименте с возможностью
                                            доставки до Склада силами транспортной компании или отдельными машинами по
                                            специальным ценам!
                                        </p>
                                        <p>
                                            Чтобы стать дилером компании POLIVAN GROUP и приобретать наши товары на
                                            дилерских условиях - вам достаточно связаться любым удобным вам способом. Мы
                                            с радостью обсудим взаимовыгодные формы сотрудничества. При положительном
                                            решении о сотрудничестве дилеру высылается Дилерский Договор с Приложениями.
                                        </p>
                                        <h3>
