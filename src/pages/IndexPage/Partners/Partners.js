...
class Partners extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            slides: [
                {
                    comment: 'Нас все устраивает в работе компании POLIVAN GROUP, особо хотим отметить коммуникабельность ваших сотрудников, с которыми всегда приятно общаться. В связи с чем выражаем благодарность за организацию рабочих процессов, благодаря которым вы можете оперативно и четко выполнять наши заказы. .',
